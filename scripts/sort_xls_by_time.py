...
cac dong du lieu theo dung thu tu ngay-gio tang dan, danh lai ID theo thu tu moi,
roi ghi de (hoac ghi ra file khac) - khong can cao lai du lieu tu baomoi.com.
...
def main():
    ...
    print(f"Da sap xep lai {len(rows)} dong theo ngay/gio tang dan -> {dest_path}")
    print(f"Tu {rows[0]['start_dt']} den {rows[-1]['start_dt']}")
